...
| birthdate        | TIMESTAMP          | The date of birth of the customer, formatted as YYYY-MM-DD (e.g., 1971-10-06).               |
| create_date      | TIMESTAMP          | The date and time when the customer record was created in the system|
...
| start_date          | TIMESTAMP          | The date when the product became available for sale or use, stored in|
...
| shipping_date   | TIMESTAMP          | The date when the order was shipped to the customer.                                          |
| due_date        | TIMESTAMP          | The date when the order payment was due.                                                      |
